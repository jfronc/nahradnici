...
candidates <- readRDS(here::here("psp/data/candidates.rds")) |>
  select(JMENO, PRIJMENI, VEK, POVOLANI, since, until, POCPROC, VOLKRAJ, NAZVOLKRAJ, KSTRANA, NAZ_STR, state)
...
candidate_table <- reactable(
  ...
  columns = list(
    ...
    POCPROC = colDef(name = "Pref. hl.", width = 80),
    POVOLANI = colDef(name = "Povolání", width = 380),
